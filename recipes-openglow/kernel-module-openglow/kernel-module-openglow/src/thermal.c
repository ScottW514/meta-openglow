...
DEFINE_FAN_PWM_ATTR(ATTR_INTAKE1_PWM, SEL_FAN(FAN_INTAKE1, REG_FAN_SETTING));
DEFINE_FAN_PWM_ATTR(ATTR_INTAKE2_PWM, SEL_FAN(FAN_INTAKE2, REG_FAN_SETTING));
...
static struct attribute *thermal_attrs[] = {
	...
	DEV_ATTR_PTR(ATTR_INTAKE1_PWM),
	DEV_ATTR_PTR(ATTR_INTAKE2_PWM),
