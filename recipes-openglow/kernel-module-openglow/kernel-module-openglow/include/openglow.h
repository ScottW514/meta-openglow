...
#define ATTR_INTAKE1_PWM            intake_1_pwm
#define ATTR_INTAKE1_TACH           intake_1_tach
#define ATTR_INTAKE2_PWM            intake_2_pwm
...
#define ATTR_INTAKE1_PWM_PATH       THERMAL_SYSFS_ATTR_DIR STR(ATTR_INTAKE1_PWM)
#define ATTR_INTAKE1_TACH_PATH      THERMAL_SYSFS_ATTR_DIR STR(ATTR_INTAKE1_TACH)
#define ATTR_INTAKE2_PWM_PATH       THERMAL_SYSFS_ATTR_DIR STR(ATTR_INTAKE2_PWM)
